...
public class WebController {
    ...
    public R orderAdd(@RequestBody OrderInfo orderInfo) {
        ...
        // 设置民宿商家余额
        HotelInfo hotelInfo = hotelInfoService.getById(orderInfo.getHotelId());
     ...
     */
    @GetMapping("/delOrder")
    public R delOrder(@RequestParam(value = "orderId") Integer orderId) {
        // 获取订单信息
        OrderInfo orderInfo = orderInfoService.getById(orderId);
        // 获取订单商家
        HotelInfo hotelInfo = hotelInfoService.getById(orderInfo.getHotelId());
        hotelInfoService.updateById(hotelInfo);
        return R.ok(orderInfoService.removeById(orderId));
    }
